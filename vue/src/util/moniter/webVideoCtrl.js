	...
	if (!e.WebVideoCtrl) {
		var t = function() {
			...
			this.I_WriteOBJECT_XHTML = function() {
				...
				null == u && null == u.object ? -1 : (I.browser().msie && (u.attachEvent("GetSelectWndInfo", GetSelectWndInfo), u.attachEvent("ZoomInfoCallback", ZoomInfoCallback), u.attachEvent("GetHttpInfo", GetHttpInfo), u.attachEvent("PluginEventHandler", PluginEventHandler)), E(), 0)
			},
			...
			var Y = function(e, t, s, n, r, o, i) {
				...
				I.extend(a, {
					success: function(a) {
						var u = new J;
						u.szIP = e,
						2 == t ? (u.szHttpProtocol = "https://", u.iHttpsPort = s) : (u.szHttpProtocol = "http://", u.iHttpPort = s),
						u.iCGIPort = s,
						u.szAuth = n,
						u.iDeviceProtocol = r,
						u.oProtocolInc = o,
				...
				if (C == u) {
					...
					I.extend(l, {
						error: function(i, l) {
							...
							I.extend(p, {
								error: function() {
									if (!W(o.cgi)) return o.error && o.error(i, l),
									void 0;
									c = I.Base64.encode(n + ":" + r),
									u = S,
									a = h;
			...
			this.I_SetVolume = function(e, t) {
				...
				n = -1;
				return - 1 != s && (n = u.HWP_SetVolume(t, e)),
				n
			},
			...
			this.I_DisableEZoom = function(e) {
				...
				if ( - 1 != t) {
					var n = p[t];
					if (n.bEZoom) return u.HWP_DisableZoom(e),
					n.bEZoom = !1,
					0
				}
				return s
			...
			this.I_Disable3DZoom = function(e) {
				...
				if ( - 1 != t) {
					var n = p[t];
					if (n.b3DZoom) return u.HWP_DisableZoom(e),
					n.b3DZoom = !1,
					0
				}
				return s
			...
			this.I_StartPlayback = function(e, t) {
				...
				if (I.extend(d, t), -1 != n) {
					...
					if (h == R && P.oStreamCapa.bSupportShttpPlay ? (o = W(d.oTransCodeParam) ? P.oProtocolInc.CGI.startShttpPlayback: P.oProtocolInc.CGI.startTransCodePlayback, i = "http://", u = d.iChannelID <= P.iAnalogChannelNum ? d.iChannelID: P.oStreamCapa.iIpChanBase + parseInt(d.iChannelID, 10) - P.iAnalogChannelNum - 1, W(d.iPort) ? "https://" == P.szHttpProtocol ? ( - 1 == P.iHttpPort && (P.iHttpPort = B(P).iHttpPort), a = P.iHttpPort) : a = P.iCGIPort: (P.iHttpPort = d.iPort, a = d.iPort)) : (o = P.oProtocolInc.CGI.startPlayback, i = "rtsp://", u = 100 * d.iChannelID + 1, W(d.iPort) || (P.iRtspPort = d.iPort), -1 == P.iRtspPort && (P.iRtspPort = B(P).iRtspPort), a = P.iRtspPort), -1 == a) return Z("获取端口号失败"),
					r;
					I.extend(d, {
						urlProtocol: i,
						cgi: o,
			...
			this.I_ReversePlayback = function(e, t) {
				...
				if (I.extend(d, t), -1 != n) {
					...
					var P = l[n],
					h = parseInt(s.$XML(m).find("ProtocolType").eq(0).text(), 10);
					if (h == R && P.oStreamCapa.bSupportShttpPlay ? (o = P.oProtocolInc.CGI.startShttpReversePlayback, i = "http://", u = d.iChannelID <= P.iAnalogChannelNum ? d.iChannelID: P.oStreamCapa.iIpChanBase + parseInt(d.iChannelID, 10) - P.iAnalogChannelNum - 1, W(d.iPort) ? "https://" == P.szHttpProtocol ? ( - 1 == P.iHttpPort && (P.iHttpPort = B(P).iHttpPort), a = P.iHttpPort) : a = P.iCGIPort: (P.iHttpPort = d.iPort, a = d.iPort)) : (o = P.oProtocolInc.CGI.startPlayback, i = "rtsp://", u = 100 * d.iChannelID + 1, W(d.iPort) || (P.iRtspPort = d.iPort), -1 == P.iRtspPort && (P.iRtspPort = B(P).iRtspPort), a = P.iRtspPort), -1 == a) return Z("获取端口号失败"),
					r;
					I.extend(d, {
						urlProtocol: i,
						cgi: o,
			...
			this.I_Frame = function(e) {
				...
				if ( - 1 != t) {
					var n = p[t],
					r = n.iPlayStatus; (r == x || r == z) && (s = u.HWP_FrameForward(e), 0 == s && (n.iPlayStatus = z))
				}
				return s
			},
			...
			this.I_GetDownloadStatus = function(e) {
				return u.HWP_GetDownloadStatus(e)
			},
			...
			this.I_ChangeWndNum = function(e) {
				return isNaN(parseInt(e, 10)) ? -1 : (u.HWP_ArrangeWindow(e), void 0)
			},
			...
			this.findDeviceIndexByIP = function(e) {
				for (var t = 0; l.length > t; t++) if (l[t].szIP == e) return t;
				return - 1
			},
			this.findWndIndexByIndex = function(e) {
				for (var t = 0; p.length > t; t++) if (p[t].iIndex == e) return t;
				return - 1
			};
			var J = function() {
				this.szIP = "",
			...
			et.prototype.processCallback = function(e, t) {
				for (var s = null,
				n = 0; this.m_httpRequestSet.length > n; n++) if (e == this.m_httpRequestSet[n].iRequestID) {
			...
			tt.prototype.ptzAutoControl = function(e, t, s, n) {
				...
				o = "",
				i = "";
				if (n.iPTZSpeed = 7 > n.iPTZSpeed ? 15 * n.iPTZSpeed: 100, t && (n.iPTZSpeed = 0), e.szDeviceType != X) o = e.iAnalogChannelNum >= r ? k(this.CGI.ptzAutoControl.analog, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID) : s.bShttpIPChannel ? k(this.CGI.ptzAutoControl.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID - e.oStreamCapa.iIpChanBase + 1 + e.iAnalogChannelNum) : k(this.CGI.ptzAutoControl.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID),
			...
			st.prototype.getDigitalChannel = function(e, t) {
				var n = k(this.CGI.getDigitalChannel, e.szHttpProtocol, e.szIP, e.iCGIPort),
				r = new et,
				o = {
					type: "GET",
			...
			st.prototype.getPortInfo = function(e, t) {
				...
				I.extend(o, {
					success: function(n) {
						...
						for (var o = s.$XML(n).find("AdminAccessProtocol", !0), i = 0, a = o.length; a > i; i++) o[i],
			...
			st.prototype.ptzAutoControl = function(e, t, s, n) {
				...
				o = "",
				i = "";
				if (n.iPTZSpeed = 7 > n.iPTZSpeed ? 15 * n.iPTZSpeed: 100, t && (n.iPTZSpeed = 0), e.szDeviceType != X) o = k(this.CGI.ptzAutoControl, e.szHttpProtocol, e.szIP, e.iCGIPort, r),
				i = "<?xml version='1.0' encoding='UTF-8'?><PTZData><pan>" + n.iPTZSpeed + "</pan>" + "<tilt>0</tilt>" + "</PTZData>";
				else {
					var a = 99;
					t && (a = 96),
			...
			rt.prototype.browser = function() {
				...
				i = e.exec(o) || t.exec(o) || s.exec(o) || n.exec(o) || 0 > o.indexOf("compatible") && r.exec(o) || ["unknow", "0"];
			...
			rt.prototype.dateFormat = function(e, t) {
				...
				for (var n in s) RegExp("(" + n + ")").test(t) && (t = t.replace(RegExp.$1, 1 == RegExp.$1.length ? s[n] : ("00" + s[n]).substr(("" + s[n]).length)));
				return t
			},
			rt.prototype.Base64 = {
				...
				encode: function(e) {
					var t, s, n, r, o, i, a, u = "",
					c = 0;
					for (e = rt.prototype.Base64._utf8_encode(e); e.length > c;) t = e.charCodeAt(c++),
					s = e.charCodeAt(c++),
					n = e.charCodeAt(c++),
					r = t >> 2,
					o = (3 & t) << 4 | s >> 4,
				...
				decode: function(e) {
					var t, s, n, r, o, i, a, u = "",
					c = 0;
					for (e = e.replace(/[^A-Za-z0-9\+\/\=]/g, ""); e.length > c;) r = this._keyStr.indexOf(e.charAt(c++)),
					...
					return u = rt.prototype.Base64._utf8_decode(u)
				},
				...
				_utf8_decode: function(e) {
					for (var t = "",
					s = 0,
					n = c1 = c2 = 0; e.length > s;) n = e.charCodeAt(s),
			...
			t.getIntegerBits = function(e, s, n) {
				...
				i = "",
				a = 0;
				for (a = 0; r.length > a; a++) o.push(r.substring(a, a + 1));
				for (a = Math.floor(s / 4); Math.floor(n / 4) >= a; a++) i += o[a] && "" != o[a] ? o[a] : "0";
				return i
			},
