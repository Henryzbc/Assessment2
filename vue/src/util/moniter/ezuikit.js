  ...
  var EZUIPlayer = function (playParams) {
    ...
    if (typeof playParams === 'object' && playParams.hasOwnProperty('decoderPath')) {
      ...
      this.loadingStart = function(){
        ...
        if(playParams && playParams.id){
          ...
          for(var i=0; i< splitBasis * splitBasis; i++){
            ...
            loadingContainer.setAttribute('style','flex-direction:column;justify-content:center;align-items: center;outline:none;vertical-align: top;');
      ...
      this.loadingSet = function(index,opt){
        ...
        textElement.innerHTML = "屏幕"+ (index + 1) + "：" + opt.text;
        if(opt.color){
